...
export default function CustomMenu({ collapsed }: Props) {
    ...
    useEffect(() => {
        ...
        const file = currentFileIdFromLocal
            ? getFileById(currentFileIdFromLocal, fileTree)
            : undefined;
            ...
            <div className="menu-list border-t border-slate-100">
                <Menu
                    ...
                    items={fileTree?.map((folder) => ({
                        ...
                        label: (
                            <Dropdown
                                menu={{ items: getFolderContextMenu(folder) }}
                                trigger={['contextMenu']}
                            >
                                <div
                                    ...
                                    >
                                        ...
                                        >
                                            <EditableText
                                                ...
                                                type={file.type}
                                                text={file.name}
                                                extraText={moment(file.gmtModified).format(
                                                    'YYYY-MM-DD HH:mm:ss'
                                                )}
                                                defaultText="Untitled"
